...
contextBridge.exposeInMainWorld("api", {
  ...
  addAdditionalDir: (p) => ipcRenderer.invoke("addAdditionalDir", p),
  removeAdditionalDir: (p) => ipcRenderer.invoke("removeAdditionalDir", p),
  getAdditionalDirs: () => ipcRenderer.invoke("getAdditionalDirs"),
  ...
  uiLog: (entry) => ipcRenderer.send("uiLog", entry),
