...
(function () {
  const EN = {
    ...
    "建 PR": "New PR",
    // —— 编程 Prompt 库 ——
    "📚 编程 Prompt 库": "📚 Prompt Library",
    "编程 Prompt 库（分场景模板）": "Prompt library (templates by scenario)",
    "搜索场景或关键词…": "Search scenario or keyword…",
    "直发": "send",
    "点击即直接发送": "Click to send immediately",
    "收藏为快捷按钮": "Pin to quick bar",
    "已收藏到快捷栏": "Pinned to quick bar",
    "🧭 理解代码": "🧭 Understand",
    "项目上手指南": "Onboarding guide",
    "解释这段代码": "Explain code",
    "梳理调用链": "Trace call chain",
    "🐛 调试排错": "🐛 Debug",
    "排查报错": "Diagnose error",
    "只读定位 bug": "Locate bug (read-only)",
    "加调试日志": "Add debug logs",
    "🔧 重构优化": "🔧 Refactor",
    "小步重构": "Refactor in small steps",
    "抽取公共逻辑": "Extract shared logic",
    "找死代码": "Find dead code",
    "🧪 测试": "🧪 Tests",
    "补单元测试": "Add unit tests",
    "修失败的测试": "Fix failing tests",
    "⚡ 性能": "⚡ Performance",
    "性能体检": "Perf checkup",
    "优化指定代码": "Optimize target code",
    "🛡 安全": "🛡 Security",
    "安全检查": "Security review",
    "📝 文档注释": "📝 Docs",
    "生成/更新 README": "Generate/update README",
    "补关键注释": "Add key comments",
    "🔀 Git 协作": "🔀 Git",
    "总结未提交改动": "Summarize uncommitted changes",
    "对比主分支差异": "Diff vs main branch",
    // —— 需求开发 ——
